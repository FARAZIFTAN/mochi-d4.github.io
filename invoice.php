...
$sql = "SELECT p.id, p.kode_invoice, p.nama_lengkap, p.email, p.alamat_pengiriman, p.tanggal_pesanan, p.total_harga, p.jumlah_produk, 
               IFNULL(pr.nama_produk, '') AS nama_produk, IFNULL(pr.id, '') AS produk_id
        FROM pesanan p
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . (isset($row['kode_invoice']) ? htmlspecialchars($row['kode_invoice']) : '') . "</td>";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; Penjualan Mochi | WebDev</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

    ...
    <nav class="navbar navbar-expand-lg bg-white text-bg-dark text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <a class="text-secondary mx-auto" href="#page-top" style="font-size: 1.5rem; font-weight: bold; text-decoration: none;">Daifuku Mochi</a>
            ...
            <div class="row justify-content-center">
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <div class="col-md-6 col-lg-4 mb-5">
                        <a href="detail produk/detail_product.php?id=<?php echo $row['id']; ?>" class="">
                            <div class="portfolio-item mx-auto">

                                <img class="img-fluid border rounded-2" src="<?php echo $row['gambar']; ?>" alt="<?php echo $row['nama_produk']; ?>" />
                                <h4>
                                    <?php echo $row['nama_produk']; ?></p>


                                    <a href="tambah_keranjang.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary w-100 mt-1"><i class="fas fa-cart-plus"></i></a>
